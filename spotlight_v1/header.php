...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ho+j7jyWK8fNQe+A12Hb8AhRq26LrZ/JpcUGGOn+Y7RsweNrtN/tE3MoK7ZeZDyx" crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" href="./includes/1500px-article.css">
    <link rel="stylesheet" href="./includes/1250px-article.css">
    <link rel="stylesheet" href="./includes/article.css">
    <link rel="stylesheet" href="./includes/1199px-article.css">
    <link rel="stylesheet" href="./includes/768px-article.css">
    <link rel="stylesheet" href="./includes/340px-article.css">
